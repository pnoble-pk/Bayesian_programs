...
// g++ bay_diabetes.cpp -o bay_diabetes
// ./bay_diabetes nr_report.txt ICD10_Obesity MSDRG_917 ICD10_A41 
//
//
...
while(!in.eof())  // read in the matrix
	...
	for (int s=1; s<(h);s++)  // new_word=stroke
		{
   		if (strcmp(word2[s],"ICD10_E08")==0) { strcpy (word2[s],new_word); flag=flag+1;}
    	if (strcmp(word2[s],"ICD10_E09")==0) { strcpy (word2[s],new_word); flag=flag+1;}
    	if (strcmp(word2[s],"ICD10_E10")==0) { strcpy (word2[s],new_word); flag=flag+1;}
    	if (strcmp(word2[s],"ICD10_E11")==0) { strcpy (word2[s],new_word); flag=flag+1;}
    	if (strcmp(word2[s],"ICD10_E12")==0) { strcpy (word2[s],new_word); flag=flag+1;}
    	if (strcmp(word2[s],"ICD10_E13")==0) { strcpy (word2[s],new_word); flag=flag+1;}
    	if (strcmp(word2[s],"ICD10_E14")==0) { strcpy (word2[s],new_word); flag=flag+1;}
    	if (strcmp(word2[s],"ICD9_250")==0) { strcpy (word2[s],new_word); flag=flag+1;}
