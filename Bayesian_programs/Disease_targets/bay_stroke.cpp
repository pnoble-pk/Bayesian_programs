...
// g++ bay_stroke.cpp -o bay_stroke
// ./bay_stroke nr_report.txt ICD10_Stroke MSDRG_917 ICD10_A41 
// ./bay_stroke nr_test.txt ICD10_Stroke ICD10_F11 ICD10_B96
//
...
while(!in.eof())  // read in the matrix
	...
	for (int s=1; s<(h);s++)  // new_word=stroke
		{
   		if (strcmp(word2[s],"ICD10_I60")==0)  { strcpy (word2[s],new_word);flag=flag+1;}
   		if (strcmp(word2[s],"ICD10_I61")==0)  { strcpy (word2[s],new_word);flag=flag+1;}
   		if (strcmp(word2[s],"ICD10_I62")==0)  { strcpy (word2[s],new_word);flag=flag+1;}
   		if (strcmp(word2[s],"ICD10_I63")==0)  { strcpy (word2[s],new_word);flag=flag+1;}
   		if (strcmp(word2[s],"ICD10_I64")==0)  { strcpy (word2[s],new_word);flag=flag+1;}
   		if (strcmp(word2[s],"ICD10_I65")==0)  { strcpy (word2[s],new_word);flag=flag+1;}
   		if (strcmp(word2[s],"ICD10_I66")==0)  { strcpy (word2[s],new_word);flag=flag+1;}
 		if (strcmp(word2[s],"ICD10_I67")==0)  { strcpy (word2[s],new_word);flag=flag+1;}
 		if (strcmp(word2[s],"ICD10_I68")==0)  { strcpy (word2[s],new_word);flag=flag+1;}
 		if (strcmp(word2[s],"ICD10_I69")==0)  { strcpy (word2[s],new_word);flag=flag+1;}
 		if (strcmp(word2[s],"ICD9_434")==0)  { strcpy (word2[s],new_word);flag=flag+1;}
